...
Mobile.tap(findTestObject('Application/android.widget.TextView - Animation'), 10)

Mobile.tap(findTestObject('Application/android.widget.TextView - Bouncing Balls'), 10)
